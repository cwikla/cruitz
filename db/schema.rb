...
ActiveRecord::Schema.define(version: 20180717213852) do
  ...
  create_table "candidates", id: :serial, force: :cascade do |t|
    ...
    t.index ["description_id"], name: "index_candidates_on_description_id"
  ...
  create_table "educations", force: :cascade do |t|
    ...
    t.string "title"
    t.integer "exp_type", default: 1, null: false
    t.integer "year_start", null: false
    t.integer "year_end"
    t.text "description"
    t.index ["head_id"], name: "index_educations_on_head_id"
  end
  ...
  create_table "head_skills", force: :cascade do |t|
    ...
    t.index ["head_id", "skill_id"], name: "index_head_skills_on_head_id_and_skill_id", unique: true
